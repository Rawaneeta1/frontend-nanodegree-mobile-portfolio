...
var resizePizzas = function(size) {
    ...
    function determineDx(elem, size) {
        ...
        //getElementById better performance than querySelector
    ...
    function changePizzaSizes(size) {
        //https://jsperf.com/getelementsbyclassname-vs-queryselectorall/59
        //change querySelecterAll by getElementByClassName allows higher operations per second
        //Because accessing the document and querying it is costly,a variable randomPizzas is created and used to store 
        //the matching elements returned by getElementsByClassName in it, 
        //then it's used  instead of running the query again and again 
